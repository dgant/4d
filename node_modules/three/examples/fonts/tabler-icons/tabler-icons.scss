...
$ti-icon-question-circle: unicode('f637');
...
.#{$ti-prefix}-360:before { content: $ti-icon-360; }
.#{$ti-prefix}-360-view:before { content: $ti-icon-360-view; }
.#{$ti-prefix}-3d-cube-sphere:before { content: $ti-icon-3d-cube-sphere; }
.#{$ti-prefix}-3d-cube-sphere-off:before { content: $ti-icon-3d-cube-sphere-off; }
...
.#{$ti-prefix}-box-seam:before { content: $ti-icon-box-seam; }
...
.#{$ti-prefix}-question-circle:before { content: $ti-icon-question-circle; }
