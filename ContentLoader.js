    ...
    switch (extension) {
      ...
      break; case 'amf':
      {
        reader.addEventListener('load', async function (event) {
          ...
          callbacks.onAddObject(amfobject);
        }, false);
        reader.readAsArrayBuffer(file);
      }
      ...
      break; case 'dae':
      {
        reader.addEventListener('load', async function (event) {
          ...
          callbacks.onAddObject(collada.scene);
        }, false);
      ...
      break; case 'ifc':
      {
        reader.addEventListener('load', async function (event) {
          ...
          callbacks.onAddObject(model.mesh);
        }, false);
        reader.readAsArrayBuffer(file);
      }
